...
<div class="container col-md-7">
    <div class="card">
        ...
        <form class="row g-3 needs-validation" style="margin-left: 10px;margin-top: 5px;" action="nuevaActividad" method="post" novalidate>
            ...
            <div class="col-12" style="text-align: center;">
                <button class="btn btn-danger" style="background-color: rgb(0, 255, 128);color: black;border-color: darkgray; margin-bottom: 10px;">Guardar
                    Actividad</button>
            </div>
        </form>
    </div>
